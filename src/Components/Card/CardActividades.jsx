            ...
            <div>
                ...
                <div className="container-slider">
                    <div className="container-buttons">
                        <button className='btn-left' onClick={()=> this.prevProp()} disabled={property.index === data.properties.length-1}><FontAwesomeIcon icon={['fas','chevron-left']}/></button>
                        <button className='btn-right'onClick={()=> this.nextProp()} disabled={property.index === 0}><FontAwesomeIcon icon ={['fas','chevron-right']}/></button>
                    </div>
