            ...
            <div className="row">
              <div className="col-6">
                ...
                <input
                  ...
                  ref={register({required:{value:true, message:'Espacio requerido'}})
                  }
                />
                <span
              ...
              <div className="col-6">
                ...
                <input
                  ...
                  ref={register({
                    required: { value: true, message: "Espacio requerido" },
                    minLength:{value: 8, message:'La contraseña debe ser mínimo 8, máximo 16'},
                    maxLength:{value:16, message:'La contraseña debe ser mínimo 8, máximo 16'}
                  })}
                />
                <span
                  className="text-danger text-small d-block mb-2"
                ...
                <input
                  ...
                  ref={register({
                    required: { value: true, message: "Espacio requerido" },
                    minLength:{value: 8, message:'La contraseña debe ser mínimo 8 carácteres'},
                    maxLength:{value:16, message:'La contraseña debe ser máximo 16 carácteres'}
                  })}
                />
                <span
                  className="text-danger text-small d-block mb-2"
