...
let newIndex = 0;
export default class CarouselMataPalo extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      imagenes: stImagenes.matapalo,
      imagen: stImagenes.matapalo[0],
    };
  }
  ...
  mostrar = () => {
    this.interval = setInterval(() => {
      this.setState({
        imagen: stImagenes.matapalo[newIndex++],
      });
      if (newIndex > stImagenes.matapalo.length - 1) newIndex = 0;
    }, 3000);
  };
  ...
  render() {
    ...
    return (
      ...
      <Carousel
        ...
        disable2={imagen.index === stImagenes.matapalo.length - 1}
      />
    );
  }
}
