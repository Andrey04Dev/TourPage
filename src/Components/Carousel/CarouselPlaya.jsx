...
export default class CarouselPlaya extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Carousel src={imagen.src} alt={imagen.alt} prevImagen={this.prevImagen} nextImagen={this.nextImagen} disable1 ={imagen.index === 0} disable2={imagen.index > stImagenes.playa.length-1}/>
            </div>
        )
    }
}
