...
let newIndex =0 
export default class CarouselZancudo extends Component {
          ...
          constructor(props) {
            ...
            this.state = {
              ...
              imagenes: stImagenes.zancudo,
              imagen: stImagenes.zancudo[0]
            };
          }
          ...
          mostrar = () => {
            this.interval = setInterval(() => {
              this.setState({
                imagen: stImagenes.zancudo[newIndex++],
              });
              if (newIndex > stImagenes.zancudo.length - 1) newIndex = 0;
            }, 3000);
          };
          ...
          render() {
            ...
            return (
              ...
              <Carousel
                ...
                disable2={imagen.index === stImagenes.zancudo.length - 1}
              />
            );
          }
}
