...
let newIndex = 0
export default class CarouselPuntaBurica extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      imagenes: stImagenes.puntaBurica,
      imagen: stImagenes.puntaBurica[0]
    };
  }
  ...
  mostrar = () => {
    this.interval = setInterval(() => {
      this.setState({
        imagen: stImagenes.puntaBurica[newIndex++],
      });
      if (newIndex > stImagenes.puntaBurica.length - 1) newIndex = 0;
    }, 3000);
  };
  ...
  render() {
    ...
    return (
      ...
      <Carousel
        ...
        disable2={imagen.index === stImagenes.puntaBurica.length - 1}
      />
    );
  }
}
